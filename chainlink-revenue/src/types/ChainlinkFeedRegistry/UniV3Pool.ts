...
export class UniV3Pool__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniV3Pool__collectResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniV3Pool__collectProtocolResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniV3Pool__mintResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniV3Pool__observationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class UniV3Pool__observeResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class UniV3Pool__positionsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class UniV3Pool__protocolFeesResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniV3Pool__slot0Result {
  value0: BigInt;
  value1: i32;
  value2: i32;
  value3: i32;
...
export class UniV3Pool__snapshotCumulativesInsideResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class UniV3Pool__swapResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniV3Pool__ticksResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class UniV3Pool extends ethereum.SmartContract {
  static bind(address: Address): UniV3Pool {
    return new UniV3Pool("UniV3Pool", address);
  }

  burn(tickLower: i32, tickUpper: i32, amount: BigInt): UniV3Pool__burnResult {
    ...
    return new UniV3Pool__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_burn(
    ...
    tickUpper: i32,
    amount: BigInt
  ): ethereum.CallResult<UniV3Pool__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new UniV3Pool__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  collect(
    ...
    return new UniV3Pool__collectResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_collect(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): ethereum.CallResult<UniV3Pool__collectResult> {
    let result = super.tryCall(
      "collect",
      "collect(address,int24,int24,uint128,uint128):(uint128,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniV3Pool__collectResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  collectProtocol(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): UniV3Pool__collectProtocolResult {
    let result = super.call(
      "collectProtocol",
    ...
    return new UniV3Pool__collectProtocolResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_collectProtocol(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): ethereum.CallResult<UniV3Pool__collectProtocolResult> {
    let result = super.tryCall(
      "collectProtocol",
      "collectProtocol(address,uint128,uint128):(uint128,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniV3Pool__collectProtocolResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  mint(
    ...
    return new UniV3Pool__mintResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_mint(
    ...
    amount: BigInt,
    data: Bytes
  ): ethereum.CallResult<UniV3Pool__mintResult> {
    let result = super.tryCall(
      "mint",
      "mint(address,int24,int24,uint128,bytes):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniV3Pool__mintResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

  observations(index: BigInt): UniV3Pool__observationsResult {
    let result = super.call(
      "observations",
    ...
    return new UniV3Pool__observationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_observations(
    index: BigInt
  ): ethereum.CallResult<UniV3Pool__observationsResult> {
    let result = super.tryCall(
      "observations",
      "observations(uint256):(uint32,int56,uint160,bool)",
      [ethereum.Value.fromUnsignedBigInt(index)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniV3Pool__observationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
  ...
  observe(secondsAgos: Array<BigInt>): UniV3Pool__observeResult {
    let result = super.call(
      "observe",
    ...
    return new UniV3Pool__observeResult(
  ...
  ): ethereum.CallResult<UniV3Pool__observeResult> {
    let result = super.tryCall(
      "observe",
      "observe(uint32[]):(int56[],uint160[])",
      [ethereum.Value.fromUnsignedBigIntArray(secondsAgos)]
  ...
  positions(key: Bytes): UniV3Pool__positionsResult {
    let result = super.call(
      "positions",
    ...
    return new UniV3Pool__positionsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_positions(key: Bytes): ethereum.CallResult<UniV3Pool__positionsResult> {
    let result = super.tryCall(
      "positions",
      "positions(bytes32):(uint128,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromFixedBytes(key)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniV3Pool__positionsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  protocolFees(): UniV3Pool__protocolFeesResult {
    let result = super.call(
      "protocolFees",
    ...
    return new UniV3Pool__protocolFeesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_protocolFees(): ethereum.CallResult<UniV3Pool__protocolFeesResult> {
    let result = super.tryCall(
      "protocolFees",
      "protocolFees():(uint128,uint128)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniV3Pool__protocolFeesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  slot0(): UniV3Pool__slot0Result {
    ...
    return new UniV3Pool__slot0Result(
      result[0].toBigInt(),
      result[1].toI32(),
      result[2].toI32(),
      result[3].toI32(),
  ...
  try_slot0(): ethereum.CallResult<UniV3Pool__slot0Result> {
    let result = super.tryCall(
      "slot0",
      "slot0():(uint160,int24,uint16,uint16,uint16,uint8,bool)",
      []
  ...
  snapshotCumulativesInside(
    tickLower: i32,
    tickUpper: i32
  ): UniV3Pool__snapshotCumulativesInsideResult {
    let result = super.call(
      "snapshotCumulativesInside",
    ...
    return new UniV3Pool__snapshotCumulativesInsideResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_snapshotCumulativesInside(
    tickLower: i32,
    tickUpper: i32
  ): ethereum.CallResult<UniV3Pool__snapshotCumulativesInsideResult> {
    let result = super.tryCall(
      "snapshotCumulativesInside",
      "snapshotCumulativesInside(int24,int24):(int56,uint160,uint32)",
      [ethereum.Value.fromI32(tickLower), ethereum.Value.fromI32(tickUpper)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniV3Pool__snapshotCumulativesInsideResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  swap(
    ...
    return new UniV3Pool__swapResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_swap(
    ...
    sqrtPriceLimitX96: BigInt,
    data: Bytes
  ): ethereum.CallResult<UniV3Pool__swapResult> {
    let result = super.tryCall(
      "swap",
      "swap(address,bool,int256,uint160,bytes):(int256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniV3Pool__swapResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  ticks(tick: i32): UniV3Pool__ticksResult {
    let result = super.call(
      "ticks",
    ...
    return new UniV3Pool__ticksResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_ticks(tick: i32): ethereum.CallResult<UniV3Pool__ticksResult> {
    let result = super.tryCall(
      "ticks",
      "ticks(int24):(uint128,int128,uint256,uint256,int56,uint160,uint32,bool)",
      [ethereum.Value.fromI32(tick)]
