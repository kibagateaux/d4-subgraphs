...
export class ChainlinkFeedRegistry__getPhaseResultPhaseStruct extends ethereum.Tuple {
  get phaseId(): i32 {
    return this[0].toI32();
  }
...
export class ChainlinkFeedRegistry__getPhaseRangeResult {
  value0: BigInt;
  value1: BigInt;
...
export class ChainlinkFeedRegistry__getRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkFeedRegistry__latestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkFeedRegistry__proposedGetRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkFeedRegistry__proposedLatestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkFeedRegistry extends ethereum.SmartContract {
  static bind(address: Address): ChainlinkFeedRegistry {
    return new ChainlinkFeedRegistry("ChainlinkFeedRegistry", address);
  }
  ...
  getPhase(
    ...
    quote: Address,
    phaseId: i32
  ): ChainlinkFeedRegistry__getPhaseResultPhaseStruct {
    let result = super.call(
      "getPhase",
    ...
    return changetype<ChainlinkFeedRegistry__getPhaseResultPhaseStruct>(
      result[0].toTuple()
    );
  }
  ...
  try_getPhase(
    ...
    quote: Address,
    phaseId: i32
  ): ethereum.CallResult<ChainlinkFeedRegistry__getPhaseResultPhaseStruct> {
    let result = super.tryCall(
      "getPhase",
      "getPhase(address,address,uint16):((uint16,uint80,uint80))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<ChainlinkFeedRegistry__getPhaseResultPhaseStruct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getPhaseRange(
    ...
    quote: Address,
    phaseId: i32
  ): ChainlinkFeedRegistry__getPhaseRangeResult {
    let result = super.call(
      "getPhaseRange",
    ...
    return new ChainlinkFeedRegistry__getPhaseRangeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getPhaseRange(
    ...
    quote: Address,
    phaseId: i32
  ): ethereum.CallResult<ChainlinkFeedRegistry__getPhaseRangeResult> {
    let result = super.tryCall(
      "getPhaseRange",
      "getPhaseRange(address,address,uint16):(uint80,uint80)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkFeedRegistry__getPhaseRangeResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getRoundData(
    ...
    quote: Address,
    _roundId: BigInt
  ): ChainlinkFeedRegistry__getRoundDataResult {
    let result = super.call(
      "getRoundData",
    ...
    return new ChainlinkFeedRegistry__getRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getRoundData(
    ...
    quote: Address,
    _roundId: BigInt
  ): ethereum.CallResult<ChainlinkFeedRegistry__getRoundDataResult> {
    let result = super.tryCall(
      "getRoundData",
      "getRoundData(address,address,uint80):(uint80,int256,uint256,uint256,uint80)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkFeedRegistry__getRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  latestRoundData(
    base: Address,
    quote: Address
  ): ChainlinkFeedRegistry__latestRoundDataResult {
    let result = super.call(
      "latestRoundData",
    ...
    return new ChainlinkFeedRegistry__latestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_latestRoundData(
    base: Address,
    quote: Address
  ): ethereum.CallResult<ChainlinkFeedRegistry__latestRoundDataResult> {
    let result = super.tryCall(
      "latestRoundData",
      "latestRoundData(address,address):(uint80,int256,uint256,uint256,uint80)",
      [ethereum.Value.fromAddress(base), ethereum.Value.fromAddress(quote)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkFeedRegistry__latestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  proposedGetRoundData(
    ...
    quote: Address,
    roundId: BigInt
  ): ChainlinkFeedRegistry__proposedGetRoundDataResult {
    let result = super.call(
      "proposedGetRoundData",
    ...
    return new ChainlinkFeedRegistry__proposedGetRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposedGetRoundData(
    ...
    quote: Address,
    roundId: BigInt
  ): ethereum.CallResult<ChainlinkFeedRegistry__proposedGetRoundDataResult> {
    let result = super.tryCall(
      "proposedGetRoundData",
      "proposedGetRoundData(address,address,uint80):(uint80,int256,uint256,uint256,uint80)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkFeedRegistry__proposedGetRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  proposedLatestRoundData(
    base: Address,
    quote: Address
  ): ChainlinkFeedRegistry__proposedLatestRoundDataResult {
    let result = super.call(
      "proposedLatestRoundData",
    ...
    return new ChainlinkFeedRegistry__proposedLatestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposedLatestRoundData(
    base: Address,
    quote: Address
  ): ethereum.CallResult<ChainlinkFeedRegistry__proposedLatestRoundDataResult> {
    let result = super.tryCall(
      "proposedLatestRoundData",
      "proposedLatestRoundData(address,address):(uint80,int256,uint256,uint256,uint80)",
      [ethereum.Value.fromAddress(base), ethereum.Value.fromAddress(quote)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkFeedRegistry__proposedLatestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
