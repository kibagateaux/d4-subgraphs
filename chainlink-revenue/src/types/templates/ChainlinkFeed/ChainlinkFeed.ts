...
export class ChainlinkFeed__getBillingResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkFeed__getRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkFeed__latestConfigDetailsResult {
  value0: BigInt;
  value1: BigInt;
  value2: Bytes;
...
export class ChainlinkFeed__latestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkFeed__latestTransmissionDetailsResult {
  value0: Bytes;
  value1: BigInt;
  value2: i32;
  value3: BigInt;
...
export class ChainlinkFeed__validatorConfigResult {
  value0: Address;
  value1: BigInt;
...
export class ChainlinkFeed extends ethereum.SmartContract {
  static bind(address: Address): ChainlinkFeed {
    return new ChainlinkFeed("ChainlinkFeed", address);
  }
  ...
  getBilling(): ChainlinkFeed__getBillingResult {
    let result = super.call(
      "getBilling",
    ...
    return new ChainlinkFeed__getBillingResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getBilling(): ethereum.CallResult<ChainlinkFeed__getBillingResult> {
    let result = super.tryCall(
      "getBilling",
      "getBilling():(uint32,uint32,uint32,uint32,uint32)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new ChainlinkFeed__getBillingResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getRoundData(_roundId: BigInt): ChainlinkFeed__getRoundDataResult {
    let result = super.call(
      "getRoundData",
    ...
    return new ChainlinkFeed__getRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getRoundData(
    _roundId: BigInt
  ): ethereum.CallResult<ChainlinkFeed__getRoundDataResult> {
    let result = super.tryCall(
      "getRoundData",
      "getRoundData(uint80):(uint80,int256,uint256,uint256,uint80)",
      [ethereum.Value.fromUnsignedBigInt(_roundId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkFeed__getRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  latestConfigDetails(): ChainlinkFeed__latestConfigDetailsResult {
    let result = super.call(
      "latestConfigDetails",
    ...
    return new ChainlinkFeed__latestConfigDetailsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBytes()
    );
  ...
  try_latestConfigDetails(): ethereum.CallResult<
    ChainlinkFeed__latestConfigDetailsResult
  > {
    let result = super.tryCall(
      "latestConfigDetails",
      "latestConfigDetails():(uint32,uint32,bytes16)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkFeed__latestConfigDetailsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBytes()
      )
  ...
  latestRoundData(): ChainlinkFeed__latestRoundDataResult {
    let result = super.call(
      "latestRoundData",
    ...
    return new ChainlinkFeed__latestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_latestRoundData(): ethereum.CallResult<
    ChainlinkFeed__latestRoundDataResult
  > {
    let result = super.tryCall(
      "latestRoundData",
      "latestRoundData():(uint80,int256,uint256,uint256,uint80)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkFeed__latestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  latestTransmissionDetails(): ChainlinkFeed__latestTransmissionDetailsResult {
    let result = super.call(
    ...
    return new ChainlinkFeed__latestTransmissionDetailsResult(
      result[0].toBytes(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toBigInt(),
  ...
  try_latestTransmissionDetails(): ethereum.CallResult<
    ChainlinkFeed__latestTransmissionDetailsResult
  > {
    let result = super.tryCall(
      "latestTransmissionDetails",
      "latestTransmissionDetails():(bytes16,uint32,uint8,int192,uint64)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkFeed__latestTransmissionDetailsResult(
        value[0].toBytes(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toBigInt(),
  ...
  validatorConfig(): ChainlinkFeed__validatorConfigResult {
    let result = super.call(
      "validatorConfig",
    ...
    return new ChainlinkFeed__validatorConfigResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_validatorConfig(): ethereum.CallResult<
    ChainlinkFeed__validatorConfigResult
  > {
    let result = super.tryCall(
      "validatorConfig",
      "validatorConfig():(address,uint32)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkFeed__validatorConfigResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
